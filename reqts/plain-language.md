...
> [!WARNING]
> **Claim not yet proven: that the within-tent bolt holds across cycles, not just 2016.** The CDF data is now loaded (`data/derived/anes_timeseries_cdf_csv_*/`), but I haven't yet built a per-cycle within-tent script — the cross-cycle trust items aren't in the same form pre-2008, so the index has to be rebuilt with cycle-level care. **Action:** say "go" and I'll add `scripts/build_within_tent_bolt_by_cycle.py` and produce a defensible cross-cycle table before publication.
...
> [!WARNING]
> **Claim not yet proven: anti-Trump messaging hit diminishing returns in 2024.** The body line about Democratic burnout is grounded in your political reading of 2024; I cannot back it from our loaded datasets. The pattern in published post-mortems matches: the largest Democratic losses were *demobilization* among young, Black, and Latino 2020 Biden voters in swing states (not switchers), and "Trump is dangerous" messaging underperformed cost-of-living and "system isn't working for me" messaging in those groups.

> [!TIP]
> **Possible sources to fetch and cite.** (1) **Catalist** *"What Happened in 2024"* memo (catalist.us, spring 2025 release). (2) **Blue Rose Research** *"Why Trump won"* post-election analysis (bluerose.us). (3) **NYT / Nate Cohn** analyses of 2020→2024 drop-off voters (Nov 2024–Feb 2025). (4) **Working Families Party** post-election memo (working-families.org). **Action:** I have permission to scrape — say "go fetch" and I'll pull, cite, and quote the load-bearing passages directly into Note [3].
