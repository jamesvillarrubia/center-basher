...
The fundamentals make the puzzle sharper, not softer. Obama won 2012 with **unemployment at 7.8%**, a worse economy than Clinton faced in 2016 (**~4.6%**) or Harris in 2024 (**~4.2%**).[1] If the economy decided alone, Obama should have lost in 2012 and Clinton or Harris should have won.

The trust→vote signal across these five cycles explains the inversion (full 14-cycle series in §15 Note [2]):[2]

| Cycle | In-party | Trust→vote β | Cast as | Result |
|---|---|---|---|---|
| 2004 | Bush (R) | +0.77 | wartime strong leader vs establishment Kerry | **WON** |
| 2012 | Obama (D) | −0.31 | residual hope/change vs establishment Romney | **WON** |
| 2016 | Clinton (D) | −0.28 | establishment continuity vs outsider Trump | **LOST** |
| 2020 | Trump (R) | +0.05 (flat) | now "the system" vs change/normalcy Biden | **LOST** |
| 2024 | Harris (D) | −0.17 | establishment continuity vs outsider Trump | **LOST** |

The pattern: **incumbents who held the outsider/change frame survived the trust drag** (Bush 2004, Obama 2012). **Successors who got cast as the establishment didn't** (Clinton 2016, Harris 2024). And **when both candidates wore the system, the trust signal went flat** and other forces decided the cycle (Biden over Trump, 2020).[3]
