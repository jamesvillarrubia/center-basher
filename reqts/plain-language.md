...
I've been using a lot of 2016 references because it was such a surprising election to so many, pollsters included. My thesis is that 2016 was the lowest-trust-era election to that point and had one of the first major outsider candidates in modern history: a true "non-institutionalist." Trump is unique in many ways, but this was, theoretically, the biggest difference.

The easy dismissal of the theories presented above is "that was a Trump thing, a 2016 thing." So we checked **every presidential election back to 1972.**[1] The pattern is rock-solid: distrustful voters reliably vote **against whoever currently holds power**. The trust signal flips with the White House in **10 of the last 14 elections**, every cycle where the signal wasn't flat. Low trust isn't pro-Republican or pro-Democrat. It's **anti-whoever's-in-charge.**[2] That's not a Trump story; it's a low-trust-era story.

This means incumbency doesn't have the advantage it used to. Biden saying "Nothing would fundamentally change" in 2019 to a room full of wealthy donors might have been a self-inflicted death blow.[3] Trump's inversion to "being part of the system" negated Biden's deep institutionalist ties. But even then the construct was "current system" vs "old system" and neither was appealing. The data confirms it: **2020 is one of the four "flat" cycles** where the trust signal didn't fire either way (Note [2]). Biden squeaked by anyway, but a more anti-institutionalist Democrat in 2020 might have won handily.

These missteps repeated with his late exit in 2024. Politically prevented from distancing herself from his administration, Kamala was doomed before her campaign properly began.[4] The lack of a jungle primary and the anointment of the penultimate insider (the VP) conferred the worst of all positions on the perception of her amongst the electorate: Kamala was such an insider they even rigged the primary *for* her. And the rule fired again: **2024's trust signal flipped back to low-trust-against-the-Democrat** (β = −0.17, Note [2]), exactly the pattern the 14-cycle rule predicts for a low-trust-era election against an opponent re-cast as the outsider.

Layer on the racial animus the right had been fomenting since Obama, and any potential swing voter was unlikely to view Kamala as a viable System Critic. Racial resentment's electoral weight had been near historic highs for sixteen years (peak **+1.55** in 2016, holding **+1.48** in 2020 and **+1.18** in 2024; see §11 [4]). So when Trump's DEI line of attack landed, the latent animus was already loaded. The attack was doubly powerful: it tapped Kamala-as-candidate *and* the latent racial animus of the average disaffected swing voter in the swing states.
...
**Both parties exploit it.** Republicans run against *"woke Dems"* every cycle. Trump's 2024 *"Kamala is for they/them, President Trump is for you"* ad is the textbook play.[6] And establishment Democrats use the same attacks against progressive primary challengers. Hillary 2016 against Bernie is the case study: when Bernie was leading in the spring primaries on his economic-populist message (MFA, Wall Street, anti-corporate consolidation), the Clinton campaign opened fire on his 2005 PLCAA vote (Protection of Lawful Commerce in Arms Act, the gun-seller liability shield), framed as Bernie *"siding with the NRA"* and *"prioritizing gun manufacturers' rights against the parents of the children killed at Sandy Hook."*[7] The substantive fight wasn't really about guns. It was about whether Bernie could be sorted onto the culture-war axis, where the progressive economic-populist coalition fragments.
